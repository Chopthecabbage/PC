...
void Item::SetItem(int ItemCode, char* ItemName, int ItemPrice,int ItemCategory, char* ItemPhoto)
{
    this->ItemCode=ItemCode;
    strcpy(this->ItemName,ItemName);
    this->ItemPrice=ItemPrice;
...
{
    cout<<"코드: "<<ItemCode<<" 이름: "<<ItemName<<" 가격: "<<ItemPrice<<" 카테고리: "<<ItemCategory<<" 경로: "<<ItemPhoto<<endl;
