...
T_Pay_Info::T_Pay_Info(char* mem_id, int mem_status, char* mem_remain,char* charge_time, int price, int payment, int mem_type)
{
    strcpy(this->mem_id, mem_id);
    this->mem_status = mem_status;
    strcpy(this->mem_remain, mem_remain);
...
void T_Pay_Info::Set_Mem_Id(char* mem_id) { strcpy(this->mem_id, mem_id); }
void T_Pay_Info::Set_Mem_Status(int mem_status) { this->mem_status = mem_status; }
void T_Pay_Info::Set_Mem_Remain(char* mem_remain) { strcpy(this->mem_remain, mem_remain); }
void T_Pay_Info::Set_Charge_Time(char* charge_time) { strcpy(this->charge_time, charge_time); }
void T_Pay_Info::Set_Price(int price) { this->price = price; }
void T_Pay_Info::Set_Payment(int payment) { this->payment = payment; }
void T_Pay_Info::Set_Mem_Type(int mem_type) { this->mem_type = mem_type; }

char* T_Pay_Info::Get_Mem_Id() { return mem_id; }
int T_Pay_Info::Get_Mem_Status() const { return mem_status; }
char* T_Pay_Info::Get_Mem_Remain() { return mem_remain; }
char* T_Pay_Info::Get_Charge_Time() { return charge_time; }
int T_Pay_Info::Get_Price() const { return price; }
int T_Pay_Info::Get_Payment() const { return payment; }
int T_Pay_Info::Get_Mem_Type() const { return mem_type; }
*/
